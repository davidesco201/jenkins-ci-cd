...
public class BookDaoTest {
    ...
    public void Given_book_list_When_addBook_Then_return_exception(){
        assertThrows(PreliminaryRegisterException.class, () -> dao.addBook("Dua Lipa"));
    }
    @Test
    public void Given_author_name_When_getBooksByAuthor_then_return_two_data(){
        List<BookEntity> listBooks;
        Book book = new Book("Harry Potter y la piedra filosofal", 1997, "J.K.Rowling", true, CategoryBook.SOFT_COVER);
        Book bookTwo = new Book("Harry Potter y la cámara secreta", 1998, "J.K.Rowling", true, CategoryBook.SOFT_COVER);
    ...
    public void Given_category_When_getBooksByCategory_then_return_two_data(){
        List<BookEntity> listBooks;
        Book book = new Book("Harry Potter y el caliz de fuego", 1997, "J.K. Rowling", true, CategoryBook.HARD_COVER);
        Book bookTwo = new Book("Harry Potter y la órden del fénix", 1998, "J.K. Rowling", true, CategoryBook.HARD_COVER);
        Book bookThree = new Book("Harry Potter y el príncipe mestizo", 1999, "J.K. Rowling", true, CategoryBook.SOFT_COVER);
        dao.registerBook(book);
        dao.registerBook(bookTwo);
        dao.registerBook(bookThree);
    ...
    public void Given_book_When_add_more_than_ten_books_Then_return_exception(){
        Book book = new Book("Harry Potter y la piedra filosofal", 1997, "J.K. Rowling", true, CategoryBook.EBOOK);
        dao.registerBook(book);
        for(int i = 0; i < 9; i++)
            dao.addBook("Harry Potter y la piedra filosofal");

        assertThrows(PreliminaryRegisterException.class, () -> dao.addBook("Harry Potter y la piedra filosofal"));
    }
}
